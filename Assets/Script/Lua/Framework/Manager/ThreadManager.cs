...
namespace LuaFramework
{
    ...
    {
        public string key;
        public List<object> eventParams = new List<object>();
    }
    ...
    public class ThreadManager : Manager
    {
        ...
        void OnUpdate()
        {
            ...
            //            {
            //                UnityEngine.CDebug.LogError(ex.Message);
            //            }
            //        }
            //    }
            //    Thread.Sleep(1);
        ...
        {
            //UnityEngine.CDebug.Log(e.ProgressPercentage);
            /*
        ...
        {
            //UnityEngine.CDebug.LogWarning("Thread evParams: >>" + evParams.Count);
